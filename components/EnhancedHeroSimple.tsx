  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative"
      >
        {/* Animated background rings using CSS */}
        <motion.div
...
const EnhancedHeroSimple: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Scene3DSimple theme={theme} interactive={true} geometryCount={12} />
...
export default EnhancedHeroSimple;